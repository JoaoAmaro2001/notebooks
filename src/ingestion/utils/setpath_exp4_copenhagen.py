...
if user == 'joaop':  # Personal computer
	try:
		root = r'Z:\Exp_4-outdoor_walk\copenhagen'  # LAN
		os.chdir(root)
		os.chdir(cdir)
	except:
		root = r'D:\Joao\Exp_4-outdoor_walk\copenhagen'  # Local
	scripts = r'C:\Users\joaop\git\JoaoAmaro2001\notebooks'
	...
	try:
		...
		root = r'I:\Joao\Exp_4-outdoor_walk\copenhagen'  # Local
	scripts = r'C:\git\JoaoAmaro2001\notebooks'
	...
	try:
		...
		root = r'I:\Joao\Exp_4-outdoor_walk\copenhagen'  # Local
	scripts = r'C:\github\JoaoAmaro2001\notebooks'
else:
